...
def demo(num_users=NUM_USERS, test_=False):
    ...
    for cmd_num in range(num_commands):
        for user_num in range(num_users):
            ...
            if test_:
                print("resp", user_num, cmd_num, app.print_cResponse(resp))
        ...
        for user_num in range(num_users):
            ...
            if test_:
                print("admin resp", user_num, cmd_num, app.print_cResponse(resp))
                if expected_resp not in resp:
                    print("admin expected", expected_resp)
                assert expected_resp in resp
        admin.audit()
